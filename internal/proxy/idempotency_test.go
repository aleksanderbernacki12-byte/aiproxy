...
func TestServer_ReloadConfig_UpdatesIdempotency(t *testing.T) {
	...
	srv.ReloadConfig(srv.Engine, nil, nil, 0, 0, 0, nil, nil, "", nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, false, proxy.NewUpstreamTransport(0), 0, nil, nil, 0, "", nil, nil, 0, nil, nil, nil, nil, false, reg)
